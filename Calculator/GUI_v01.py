...
class Ui_MainWindow(object):
    ...
    def insertTab_ejes(self, title):
        ...
        #Se crea el GroupBox de resultados
        self.groupBox_resultados = QtWidgets.QGroupBox(self.Calculo_ejes_tab)
        self.groupBox_resultados.setGeometry(QtCore.QRect(20, 340, 1201, 391))
        self.groupBox_resultados.setObjectName("groupBox_resultados")

        #Se crea el cuadro de graficos 1
        self.graphicsView = QtWidgets.QGraphicsView(self.groupBox_resultados)
        ...
        self.groupBox_resultados.setTitle(_translate("MainWindow", "Resultados"))
        self.unidades_diametros_minimos_label.setText(_translate("MainWindow", "Diametros minimos"))
        ...
        self.unidades_diametros_minimos_comboBox.setItemText(0, _translate("MainWindow", "mm"))
        self.unidades_diametros_minimos_comboBox.setItemText(1, _translate("MainWindow", "in"))
        self.resultado_de_goodman_label.setText(_translate("MainWindow", "0"))
        self.resultado_de_gerber_label.setText(_translate("MainWindow", "0"))
